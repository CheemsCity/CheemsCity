...
class PID:
    ...
    def __init__(self, kp, ki, kd):
        ...
        self.ki = ki
        self.kd = kd
        # scriviamo il PID in tempo discreto che avra bisogno di queste variabili ausiliarie:
        ...
        self.i = 0  # arrivati a tot si azzera per non alzare l'integrale
        self.Integral = 0
    ...
    def compute(self, pv):
        ...
        self.Derivative = ((self.error - self.lastError) /
                           self.deltaTime) if self.deltaTime > 0 else 0
        if (self.i == 40):  #tot da decidere
            i = 0
            self.Integral = 0
        ...
        #il valore dell'output andra tra 0 e 50
    ...
    def tune(self, kp, ki, kd):
        print("Setto il coefficiente P a : " + str(kp))
        self.kp = kp
        print("Setto il coefficiente I a : " + str(ki))
        self.ki = ki
        print("Setto il coefficiente D a : " + str(kd))
        self.kd = kd
